        ...
        >
          ...
          <View style={[styles.card, { backgroundColor: theme === 'light' ? '#FFFFFF' : '#1C1C1E', borderColor: theme === 'light' ? 'rgba(0, 0, 0, 0.08)' : 'rgba(255, 255, 255, 0.12)' }]}>
            <View style={styles.sectionHeader}>
              ...
              >
                ...
                <AppText size="small" bold text={t('updateUser.addPhone') || 'Add'} styles={{ color: themeColors.primaryForeground, marginLeft: 4 }} />
              </Pressable>
            </View>
          ...
          <View style={[styles.card, { backgroundColor: theme === 'light' ? '#FFFFFF' : '#1C1C1E', borderColor: theme === 'light' ? 'rgba(0, 0, 0, 0.08)' : 'rgba(255, 255, 255, 0.12)' }]}>
            <View style={styles.sectionHeader}>
              ...
              >
                <IconApp pack="FI" name="plus" size={14} color={themeColors.primaryForeground} />
                <AppText size="small" bold text={t('updateUser.addEmail') || 'Add'} styles={{ color: themeColors.primaryForeground, marginLeft: 4 }} />
              </Pressable>
            </View>
